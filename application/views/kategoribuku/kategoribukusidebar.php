                ...
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <?php if($this->session->userdata('level')==='1'):?>
                            ...
                            <li>
                                <a href="" class="active-menu"><i class="fa fa-desktop"></i> Data Master<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="<?php echo base_url("Kategoribuku");?>" class="active-menu"S><i class="fa fa-sitemap"></i> Kategori Buku</a>
                                    </li>
