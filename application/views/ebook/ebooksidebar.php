                ...
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <!-- <?php //if($this->session->userdata('level')==='1'):?> -->
                            ...
                            <li>
                                <a href="" class="active-menu"><i class="fa fa-desktop"></i> Data Admin<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                    ...
                                    <li>
                                        <a href="<?php echo base_url("Ebook");?>" class="active-menu"><i class="fa fa-book"></i> Ebook<span><font color="red"> *NEW</font></span></a>
                                    </li>
                                </ul>
                            </li>   
                           ...
                           <!--  <?php //elseif($this->session->userdata('level')==='2'):?>
                                ...
                                <li>
                                    ...
                                    <ul class="nav nav-second-level">
                                        ...
                                        <li>
                                            <a href="<?php echo base_url("Buku");?>" class="active-menu"><i class="fa fa-bar-chart-o"></i> Buku</a>
                                        </li>
