                ...
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <?php if($this->session->userdata('level')==='1'):?>
                            ...
                            <li>
                                <a href="" class="active-menu"><i class="fa fa-desktop"></i> Data Transaksi<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="<?php echo base_url("Peminjaman");?>"><i class="fa fa-table"></i> Peminjaman Buku</a>
                                    </li>                        
                                    <li>
                                        <a href="<?php echo base_url("Pengembalian");?>" class="active-menu"><i class="fa fa-edit"></i> Pengembalian Buku</a>
                                    </li>
                                </ul>
                            </li>       
