                ...
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <?php if($this->session->userdata('level')==='1'):?>
                            ...
                            <li>
                                <a href="" class="active-menu"><i class="fa fa-desktop"></i> Laporan<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="<?php echo base_url("Lappeminjaman");?>" ><i class="fa fa-fw fa-file"></i> Lap Peminjaman</a>
                                    </li>
                                                                    <li>
                                        <a href="<?php echo base_url("Lappengembalian");?>" class="active-menu"><i class="fa fa-fw fa-file"></i> Lap Pengembalian</a>
                                    </li>                       
                                </ul>
                            </li>
